# CropGuard AI – Precision Pest Management System
...
docker run -p 8000:8000 --env-file .env cropguard-ai
```
...
DATABASE_URL=sqlite:///instance/cropguard.db
